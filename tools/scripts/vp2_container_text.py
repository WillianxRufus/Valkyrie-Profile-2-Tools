...
def main():
    ...
    export.add_argument("--subresource", type=lambda v: int(v, 0), default=None,
                        help="PK1 row holding the bank, for a resource whose "
                             "text is not in the first one")
